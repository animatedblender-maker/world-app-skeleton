...
export class PostsService {
  ...
  async postsByCountry(code, limit, viewerId) {
  ...
  async postsByAuthor(authorId, limit, viewerId) {
  ...
  async postById(postId, viewerId) {
    if (!postId)
      return null;
  ...
  async likesByPost(postId, limit, viewerId) {
  ...
  async resolveCategoryId(countryCode) {
