...
export class PresenceService {
    ...
    ttlSeconds = Number(process.env.PRESENCE_TTL_SECONDS ?? 70);
    getTTL() {
    ...
    async globalStats() {
        ...
        const totalQ = await pool.query(`select count(*)::text as n from public.profiles`);
